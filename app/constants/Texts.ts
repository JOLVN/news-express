export const Texts = {
    fr: {
        ...
        upgradeTitle2: "gratuitement pendant 1 mois",
        creditsByMonth: "200 crédits / mois",
        accessBookmarks: "Accès aux favoris",
        annualSubscription: "Annuel",
        monthlySubscription: "Mensuel",
        annualSubscriptionDescription: "par an après 1 mois d'essai",
        monthlySubscriptionDescription: "par mois après 1 mois d'essai",
        discount: "ÉCONOMISEZ 20%",
        subscriptionButton: "Commencer l'essai gratuit ⚡️",
        subscriptionInfo: "Vous serez facturé €XX.XX par UU après la fin de votre essai gratuit de 1 mois. Vous pouvez annuler à tout moment.",
        year: "an",
        month: "mois",
        // Errors
        error: "Erreur",
    ...
    en: {
        ...
        // Upgrade
        upgradeTitle1: "Try",
        upgradeTitle2: "free for 1 month",
        creditsByMonth: "200 credits / month",
        accessBookmarks: "Access to bookmarks",
        annualSubscription: "Annual",
        monthlySubscription: "Monthly",
        annualSubscriptionDescription: "per year after 1 month trial",
        monthlySubscriptionDescription: "per month after 1 month trial",
        discount: "SAVE 20%",
        subscriptionButton: "Start 1 month free trial ⚡️",
        subscriptionInfo: "You’ll be charged €XX.XX per UU after your 1 month free trial ends. You can cancel anytime.",
        year: "year",
        month: "month",
        // Errors
        error: "Error",
